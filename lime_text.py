...
from .utils.generic_utils import generate_samples_text
...
class LimeTextExplainer(object):
    ...
    def explain_instance(self,
        ...
        data, yss, distances = self.__data_labels_distances(
            ...
            distance_metric=distance_metric, batch_size=batch_size,
    ...
    def __data_labels_distances(self,
        ...
        inverse_data, data = generate_samples_text(doc_size, num_samples, indexed_string, self.random_state, distribution=distribution, kernel_width=self.kernel_width)
